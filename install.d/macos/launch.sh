...
source "$GSDOT_SCRIPTS/install-lazyvim.sh"
...
source "$GSDOT_SCRIPTS/macos/yos-main-configs.sh"
...
# source "$GSDOT_SCRIPTS/macos/yos-peripherals.sh" >/dev/null 2>&1
source "$GSDOT_SCRIPTS/macos/yos-peripherals.sh"
...
source "$GSDOT_SCRIPTS/macos/yos-screenshots.sh" >/dev/null 2>&1
# source "$GSDOT_SCRIPTS/themes.sh" >/dev/null 2>&1
source "$GSDOT_SCRIPTS/themes.sh"
