...
1. Brave - the best privacy-oriented browser of late. Also includes Chrome and Firefox.  Yes Brave supports Tor links, which is why I didn't include the Tor browser.
